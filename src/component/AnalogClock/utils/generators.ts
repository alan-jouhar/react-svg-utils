...
function generateHoursLineCoordsFromTime(date: Date, lineLength: number, origin: Point): LineCoordinates {
  ...
  return generateLineCoords({ ...origin }, lineLength, theta - 90, 100);
}
function generateMinutesLineCoordsFromTime(date: Date, lineLength: number, origin: Point): LineCoordinates {
  let minutes = date.getMinutes();
...
function generateSecondsLineCoordsFromTime(date: Date, lineLength: number, origin: Point): LineCoordinates {
